...
In a nutshell, DH provides a solution to a very essential cryptographic requirement: To allow two parties who have never met to agree on a shared secret key by communicating in such a way that the secret can't be seen by observing the communication. There is an important distinction in here: The two are not sharing an existing scret key during the communication, they are creating a secret key together.
...
OWASP top 10 vulnerabilities for web application security. The complete report can be found at <https://www.owasp.org/index.php/Category:OWASP_Top_Ten_Project> on OWASP website. The OWASP Top 10 is a powerful awareness document for web application security. It represents a broad consensus about the most critical security risks to web applications. 
